        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">PORTAL</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ (request()->routeIs('target.*')) ? 'active' : '' }}">
              <a href="{{route('target.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-target-lock"></i>
                <div data-i18n="Analytics">Target</div>
              </a>
            </li>
            @if(checkPermission(['superuser']))
            <li class="menu-item {{ (request()->routeIs('reminder.*')) ? 'active' : '' }}">
              <a href="{{route('reminder.index')}}" class="menu-link">
